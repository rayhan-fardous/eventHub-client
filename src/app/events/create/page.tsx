...
import { Plus, Trash2, Calendar, MapPin, Tag, Clock, Users, Mail, Image as ImageIcon, Sparkles, ArrowRight } from 'lucide-react';
...
export default function CreateEventPage() {
  ...
  return (
    <div className="min-h-screen bg-brand-bg text-brand-text-primary flex flex-col justify-between relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 -translate-x-1/2 -z-10 h-96 w-96 rounded-full bg-brand-indigo-glow filter blur-[120px] opacity-30 animate-pulse-glow" />
      ...
      <main className="flex-grow mx-auto max-w-4xl w-full px-4 pt-12 pb-20 sm:px-6 lg:px-8">
        ...
        <section className="text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="mt-2 text-sm sm:text-base text-brand-text-secondary">
            Publish your workshop, summit, hackathon or seminar. It takes only a few minutes to set up.
          </p>
        </section>
