...
export default function Footer() {
  return (
    <footer className="border-t border-brand-border bg-brand-panel/30 py-12 relative overflow-hidden shrink-0">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-10 text-left">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-4 text-xs sm:text-sm text-brand-text-secondary leading-relaxed max-w-xs">
          ...
          {/* Column 1: Explorer */}
          <div>
            <h4 className="text-xs font-semibold text-brand-text-primary uppercase tracking-wider mb-4">
              Explore
            </h4>
        ...
        {/* Divider */}
        <div className="h-px bg-brand-border/60 w-full mb-8" />
